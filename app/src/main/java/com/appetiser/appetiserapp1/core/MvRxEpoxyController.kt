 ...
 */
fun <A : BaseMvRxViewModel<B>, B : MvRxState, C : BaseMvRxViewModel<D>, D : MvRxState> BindingMvRxActivity<*>.simpleController(
    viewModel1: A,
    viewModel2: C,
 ...
 * When models are built the current state of the viewmodels will be provided.
 */
fun <A : BaseMvRxViewModel<B>, B : MvRxState, C : BaseMvRxViewModel<D>, D : MvRxState, E : BaseMvRxViewModel<F>, F : MvRxState> BindingMvRxActivity<*>.simpleController(
    viewModel1: A,
    viewModel2: C,
    viewModel3: E,
